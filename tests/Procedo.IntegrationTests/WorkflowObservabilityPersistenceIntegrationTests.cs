...
{
    [Fact]
    public async Task ExecuteWithPersistenceAsync_Should_Emit_Resumed_Run_And_StepSkipped()
    {
        ...
        try
        {
            ...
            Assert.Contains(sink.Events, e => e.EventType == ExecutionEventType.StepSkipped && e.StepId == "a");
            Assert.Contains(sink.Events, e => e.EventType == ExecutionEventType.StepSkipped && e.StepId == "b");
